...
const Home = () => {
  return (
    <div name="home" className='home md:h-screen pt-20'>
        <div className=' max-w-screen-md  lg:max-w-screen-lg px-5 sm:px-12  mx-auto md:flex py-16 md:py-0 items-center h-full'>
            <div className=''>
                ...
                <p className='text-[#8892B0] py-4 text-[17px]'>
                    ...
                    e-commerce web application like <span className='text-[#5FF1D0]'>Walmart</span>.
                </p>
                <div>
                    <Link
                        to="portfolio"
